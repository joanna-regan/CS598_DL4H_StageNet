...
if __name__ == '__main__':
    ...
    if args.test_mode == 1:
        ...
        model = StageNet_I(76+17, 384, 10, 1, 3, 0.3, 0.3, 0.3).to(device)
        optimizer = torch.optim.Adam(model.parameters(), lr=args.lr)
        
        print("loading pre-trained StageNet-I model")
        checkpoint = torch.load('./saved_weights/trained_model_ablation1.zip', map_location = device)
